...
import com.masmu.logextras.adapters.CallLogAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Log Extras");
    ...
    private void SettingUpPeriodicWork() {
        ...
        workManager.enqueueUniquePeriodicWork("SendDataWorker", ExistingPeriodicWorkPolicy.KEEP, periodicSendDataWork);
    }
...
//            SendDataToServer(callLogItem);
    ...
    private void SendDataToServer(CallLogModel callLogItem) {
        ...
        DatabaseReference myRef = database.getReference("CallLog")
                .child(getDeviceId(this) +" - "+ getDeviceName())
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = "Log Extras";
            String description = "Channel for Log Extras";
